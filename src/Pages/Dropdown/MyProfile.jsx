    ...
    <div className="min-h-screen flex justify-center items-center mt-5 md:mt-10 p-6">
      ...
      <div className="max-w-5xl w-full bg-white dark:bg-black rounded-3xl shadow-2xl p-8 flex flex-col md:flex-row gap-10">
        ...
        <div className="flex flex-col items-center md:w-1/3 text-center">
          ...
          <div className="flex items-center justify-center mt-2 bg-gradient-to-r from-pink-500 to-red-500 text-white px-4 py-1 rounded-full text-sm font-medium">
          ...
          <div className="w-full mt-6">
            ...
            <div className="w-full h-4 bg-gray-200 rounded-full">
              <div
                className="h-4 rounded-full bg-gradient-to-r from-pink-500 to-red-500 transition-all duration-500"
        ...
        <div className="md:w-2/3 flex flex-col gap-4">
          ...
          <button
            ...
            className="mt-4 py-3 w-1/2 bg-gradient-to-r from-pink-500 to-red-600 text-white font-semibold rounded-lg hover:opacity-90 transition cursor-pointer"
          >
            Update Profile
          </button>
        </div>
