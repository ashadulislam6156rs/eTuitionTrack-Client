  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="bg-white shadow-xl rounded-2xl p-8 max-w-lg w-full text-center animate-fadeIn">
        ...
        <ul className="text-left text-gray-600 mb-6 list-disc list-inside space-y-2">
        ...
        <Link
          ...
          className="inline-block bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 mb-4"
        >
          Try Again
        </Link>
      </div>
