    ...
    return (
      <div>
        ...
        <p className="text-sm text-center md:w-3/4 mx-auto text-base-content/60 pb-7 pt-2">
          A complete summary of all the tuitions you have earned from. Track
          your confirmed payments, student info, subjects, and total revenue
          generated from your tutoring services.
        </p>
