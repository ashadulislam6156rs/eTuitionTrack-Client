    ...
    <div className="max-w-7xl mx-auto">
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content">
          {/* Navbar */}
          <nav className="navbar w-full bg-[#fdf7e4b6] dark:bg-gray-800 shadow-lg">
            <label
              htmlFor="my-drawer-4"
            ...
            <div className="px-4 text-[#F57C00] dark:text-orange-400 font-bold text-xl">
              eTuition
              <span className="text-[#29B6F6] dark:text-cyan-400">Track</span>
            </div>
          </nav>
          {/* Page content here *******************************/}
          <div className="p-4 bg-base-300 dark:bg-gray-900 min-h-screen">
        ...
        <div className="drawer-side is-drawer-close:overflow-visible">
          ...
          ></label>
          <div className="flex min-h-full flex-col items-start bg-white dark:bg-gray-800 md:bg-[#29b5f642] dark:md:bg-gray-800/95 is-drawer-close:w-14 is-drawer-open:w-64">
            {/* Sidebar content here *************************** */}
            <ul className="menu w-full grow font-semibold text-[#0D47A1] dark:text-gray-200">
              {/* List item */}
              <li>
                <NavLink
                  to={"/"}
                  className={({ isActive }) =>
                    isActive
                      ? "text-[#F57C00] dark:text-orange-400"
                      : "is-drawer-close:tooltip is-drawer-close:tooltip-right hover:text-[#F57C00] dark:hover:text-orange-400"
                  }
                  data-tip="Home"
                >
                  {/* Home icon */}
